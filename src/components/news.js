                  ...
                  <Card className='news_card'>
                    <CardContent>
                      ...
                      <div className='read_more'>
                        <a href={item.item1.link} target="_blank" rel="noreferrer">
                          <button className='news_learn_button'>
                            Read More
                          </button>
                        </a>
                      </div>
                    ...
                    <div className='news_card_2'>
                      <Card className='news_card'>
                        <CardContent>
                          ...
                          <div className='read_more'>
                            <a href={item.item2.link} target="_blank" rel="noreferrer">
                              <button className='news_learn_button'>
                                Read More
                              </button>
                            </a>
                    ...
                    <div className='news_card_3'>
                      <Card className='news_card'>
                        <CardContent>
                          ...
                          <div className='read_more'>
                            <a href={item.item3.link} target="_blank" rel="noreferrer">
                              <button className='news_learn_button'>
                                Read More
                              </button>
                            </a>
