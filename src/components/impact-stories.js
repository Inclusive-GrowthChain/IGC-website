                ...
                <Card className='impact_stories_card'>
                  <CardContent className='impact_stories_card_content'>
                    ...
                    <div className='impact_stories_card_text'>
                      ...
                      <p className='impact_stories_card_text_p' style={{ marginTop: '4rem' }}><sup>1</sup><a href="https://health.economictimes.indiatimes.com/news/pharma/the-state-of-pharmaceutical-industry-in-india-an-overview/60273583" target="_blank" rel="noreferrer">Indian pharmaceutical industry: The State of Pharmaceutical Industry in India – An Overview, Health News, ET HealthWorld (indiatimes.com)</a></p>
                      <p className='impact_stories_card_text_p'><sup>2</sup><a href="https://www.ibef.org/industry/pharmaceutical-india" target="_blank" rel="noreferrer">Pharma Industry in India: Pharma Sector Overview, Market Size, Analysis...| IBEF</a></p>
                      <p className='impact_stories_card_text_p'><sup>3</sup><a href="https://science.thewire.in/health/brazils-drug-regulator-rejects-import-of-bharat-biotechs-covaxin/" target="_blank" rel="noreferrer">Brazil Drug Regulator Rejects Bharat Biotech's Application To Import Covaxin - The Wire Science</a></p>
                    </div>
                  </CardContent>
                </Card>
              )
